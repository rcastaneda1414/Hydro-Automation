...
;list
Global $ltagIUIAutomationElement = "SetFocus;" & _
"GetRuntimeId;" & _
"FindFirst;" & _
"FindAll;" & _
...
;list
Global $ltagIUIAutomationCondition = ""
...
;list
Global $ltagIUIAutomationElementArray = "Length;" & _
"GetElement;"
...
;list
Global $ltagIUIAutomationCacheRequest = "AddProperty;" & _
"AddPattern;" & _
"Clone;" & _
"TreeScope;" & _
"TreeScope;" & _
...
;list
Global $ltagIUIAutomationBoolCondition = "BooleanValue;"
...
;list
Global $ltagIUIAutomationPropertyCondition = "propertyId;" & _
"PropertyValue;" & _
...
;list
Global $ltagIUIAutomationAndCondition = "ChildCount;" & _
...
"GetChildren hresult(ptr*);"
;list
Global $ltagIUIAutomationOrCondition = "ChildCount;" & _
"GetChildrenAsNativeArray;" & _
"GetChildren;"
...
;list
Global $ltagIUIAutomationNotCondition = "GetChild;"
...
;list
Global $ltagIUIAutomationTreeWalker = "GetParentElement;" & _
...
;list
Global $ltagIUIAutomationEventHandler = "HandleAutomationEvent;"
...
;list
Global $ltagIUIAutomationPropertyChangedEventHandler = "HandlePropertyChangedEvent;"
...
;list
Global $ltagIUIAutomationStructureChangedEventHandler = "HandleStructureChangedEvent;"
...
;list
Global $ltagIUIAutomationFocusChangedEventHandler = "HandleFocusChangedEvent;"
...
;list
Global $ltagIUIAutomationInvokePattern = "Invoke;"
...
;list
Global $ltagIUIAutomationDockPattern = "SetDockPosition;" & _
...
;list
Global $ltagIUIAutomationExpandCollapsePattern = "Expand;" & _
"Collapse;" & _
...
;list
Global $ltagIUIAutomationGridPattern = "GetItem;" & _
"CurrentRowCount;" & _
...
;list
Global $ltagIUIAutomationGridItemPattern = "CurrentContainingGrid;" & _
"CurrentRow;" & _
"CurrentColumn;" & _
"CurrentRowSpan;" & _
"CurrentColumnSpan;" & _
...
;list
Global $ltagIUIAutomationMultipleViewPattern = "GetViewName;" & _
"SetCurrentView;" & _
...
;list
Global $ltagIUIAutomationRangeValuePattern = "SetValue;" & _
"CurrentValue;" & _
"CurrentIsReadOnly;" & _
"CurrentMaximum;" & _
"CurrentMinimum;" & _
...
;list
Global $ltagIUIAutomationScrollPattern = "Scroll;" & _
"SetScrollPercent;" & _
...
;list
Global $ltagIUIAutomationScrollItemPattern = "ScrollIntoView;"
...
;list
Global $ltagIUIAutomationSelectionPattern = "GetCurrentSelection;" & _
...
;list
Global $ltagIUIAutomationSelectionItemPattern = "Select;" & _
"AddToSelection;" & _
...
"Cancel hresult();"
;list
Global $ltagIUIAutomationSynchronizedInputPattern = "StartListening;" & _
"Cancel;"
...
;list
Global $ltagIUIAutomationTablePattern = "GetCurrentRowHeaders;" & _
...
;list
Global $ltagIUIAutomationTableItemPattern = "GetCurrentRowHeaderItems;" & _
...
;list
Global $ltagIUIAutomationTogglePattern = "Toggle;" & _
...
;list
Global $ltagIUIAutomationTransformPattern = "Move;" & _
"Resize;" & _
"Rotate;" & _
"CurrentCanMove;" & _
"CurrentCanResize;" & _
...
;list
Global $ltagIUIAutomationValuePattern = "SetValue;" & _
"CurrentValue;" & _
"CurrentIsReadOnly;" & _
"CachedValue;" & _
"CachedIsReadOnly;"
...
;list
Global $ltagIUIAutomationWindowPattern = "Close;" & _
"WaitForInputIdle;" & _
...
"GetChildren hresult(ptr*);"
;list
Global $ltagIUIAutomationTextRange = "Clone;" & _
"Compare;" & _
"CompareEndpoints;" & _
...
"GetElement hresult(int;ptr*);"
;list
Global $ltagIUIAutomationTextRangeArray = "Length;" & _
"GetElement;"
...
;list
Global $ltagIUIAutomationTextPattern = "RangeFromPoint;" & _
"RangeFromChild;" & _
"GetSelection;" & _
"GetVisibleRanges;" & _
"DocumentRange;" & _
...
;list
Global $ltagIUIAutomationLegacyIAccessiblePattern = "Select;" & _
"DoDefaultAction;" & _
"SetValue;" & _
"CurrentChildId;" & _
"CurrentName;" & _
...
Global $dtagIAccessible = "accParent hresult(idispatch*);" & _
"accChildCount hresult(long*);" & _
"accChild hresult(variant;idispatch*);" & _
"accName hresult(variant;bstr*);" & _
"accValue hresult(variant;bstr*);" & _
"accDescription hresult(variant;bstr*);" & _
"accRole hresult(variant;variant*);" & _
"accState hresult(variant;variant*);" & _
"accHelp hresult(variant;bstr*);" & _
"accHelpTopic hresult(bstr*;variant;long*);" & _
"accKeyboardShortcut hresult(variant;bstr*);" & _
"accFocus hresult(variant*);" & _
"accSelection hresult(variant*);" & _
"accDefaultAction hresult(variant;bstr*);" & _
...
"accName hresult(variant;bstr);" & _
"accValue hresult(variant;bstr);"
;list
Global $ltagIAccessible = "accParent;" & _
"accChildCount;" & _
"accChild;" & _
"accName;" & _
"accValue;" & _
...
;list
Global $ltagIUIAutomationItemContainerPattern = "FindItemByProperty;"
...
;list
Global $ltagIUIAutomationVirtualizedItemPattern = "Realize;"
...
;list
Global $ltagIUIAutomationProxyFactory = "CreateProvider;" & _
"ProxyFactoryId;"
...
;list
Global $ltagIRawElementProviderSimple = "ProviderOptions;" & _
...
;list
Global $ltagIUIAutomationProxyFactoryEntry = "ProxyFactory;" & _
"ClassName;" & _
"ImageName;" & _
...
;list
Global $ltagIUIAutomationProxyFactoryMapping = "count;" & _
"GetTable;" & _
"GetEntry;" & _
"SetTable;" & _
"InsertEntries;" & _
...
"AddPropertyChangedEventHandlerNativeArray hresult(ptr;long;ptr;ptr;int;int);" & _
...
;list
Global $ltagIUIAutomation = "CompareElements;" & _
"CompareRuntimeIds;" & _
"GetRootElement;" & _
"ElementFromHandle;" & _
"ElementFromPoint;" & _
